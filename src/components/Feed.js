...
const Feed = () => {
    ...
    const [posts, setPosts] = useState([
        { id: 1, image: 'images/dog1.jpg', name: 'Buddy', city: 'New York', description: 'A friendly dog', startDate:'09/09/24',endDate:'19/09/24' ,gender: 'male', needsGarden:'no' },
        { id: 2, image: 'images/dog2.jpg', name: 'Max', city: 'Los Angeles', description: 'Loves to play',startDate:'10/08/24',endDate:'24/08/24' , gender: 'male', needsGarden:'Yes' },
        { id: 3, image: 'images/dog3.jpg', name: 'Bella', city: 'Chicago', description: 'Very cuddly', startDate:'10/06/24',endDate:'13/06/24' , gender: 'female', needsGarden:'no' },
        { id: 4, image: 'images/dog4.jpg', name: 'Charlie', city: 'Houston', description: 'Enjoys long walks',startDate:'10/06/24',endDate:'10/09/24' , gender: 'male', needsGarden:'Yes' },
        { id: 5, image: 'images/dog5.jpg', name: 'Lucy', city: 'Phoenix', description: 'Great with kids', startDate:'07/06/24',endDate:'07/07/24'  , gender: 'female', needsGarden:'Yes'},
        { id: 6, image: 'images/dog6.jpg', name: 'Daisy', city: 'Philadelphia', description: 'Loves treats', startDate:'12/06/24',endDate:'22/10/24' , gender: 'female', needsGarden:'no'},
        { id: 7, image: 'images/dog7.jpg', name: 'Rocky', city: 'San Antonio', description: 'Very energetic', startDate:'12/06/24',endDate:'23/10/24'  , gender: 'male', needsGarden:'Yes'},
